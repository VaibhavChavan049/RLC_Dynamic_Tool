...
export function ZoomInIcon({ size = 17 }: IconProps) {
  return (
...
export function ZoomOutIcon({ size = 17 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...shared}>
      <circle cx="10.5" cy="10.5" r="6.5" />
      <path d="M7.5 10.5h6" />
...
export function ResetZoomIcon({ size = 17 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...shared}>
...
export function BandwidthTargetIcon({ size = 17 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...shared}>
...
export function ExitFullscreenIcon({ size = 17 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...shared}>
...
export function DownloadIcon({ size = 17 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" {...shared}>
      <path d="M12 3v12" />
